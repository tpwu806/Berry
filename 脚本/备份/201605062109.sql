...
insert  into `device_device`(`ID`,`DEVICENAME`,`DEVICEIP`,`DEVICEPORT`,`DEVICESTATUS`,`DEVICETYPE`,`SENSORNUMBER`) values (1,'树莓派','172.16.8.109','6789',0,'2b',0),(2,'a8','172.16.8.110','6789',0,' a8',0);
...
insert  into `task_task`(`ID`,`DEVICEID`,`STARTTIME`,`STOPTIME`,`TASKSTATUS`) values (1,1,'2016-05-06 20:54:12','2016-05-06 20:54:48','0');
