...
CREATE TABLE `device_device` (
  ...
  `DEVICESTATUS` int(10) NOT NULL COMMENT '设备状态',
...
insert  into `device_device`(`ID`,`DEVICENAME`,`DEVICEIP`,`DEVICEPORT`,`DEVICESTATUS`,`DEVICETYPE`,`SENSORNUMBER`) values (1,'树莓派','localhost','6789',0,'2b',0),(2,'a8','172.16.8.110','6789',0,' a8',0);
...
insert  into `sensor_sensor`(`ID`,`DEVICEID`,`SENSORNAME`,`SENSORTYPE`,`SENSORPARAMETER`,`SENSORPARAMETER2`) values (1,1,'dht11','温湿度',1,2);
...
CREATE TABLE `supervise_supervise` (
  ...
  `SUPERVISEVALUE` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '参数一值',
  `SUPERVISEVALUE2` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '参数二值',
...
insert  into `supervise_supervise`(`ID`,`TASKID`,`SUPERVISETIME`,`SUPERVISEVALUE`,`SUPERVISEVALUE2`,`WARNINGCLASS`) values (82,1,'2016-05-15 14:32:00','GET','666',0),(83,1,'2016-05-15 14:32:02','GET','666',0),(84,1,'2016-05-15 14:32:04','GET','666',0),(85,1,'2016-05-15 14:32:06','GET','666',0),(86,1,'2016-05-15 14:32:08','GET','666',0),(87,1,'2016-05-15 14:32:10','GET','666',0),(88,1,'2016-05-15 14:32:12','GET','666',0),(89,1,'2016-05-15 14:32:14','GET','666',0),(90,1,'2016-05-15 14:32:16','GET','666',0),(91,1,'2016-05-15 14:32:18','GET','666',0),(92,1,'2016-05-15 14:32:20','GET','666',0),(93,1,'2016-05-15 14:32:22','GET','666',0),(94,1,'2016-05-15 14:32:24','GET','666',0),(95,1,'2016-05-15 14:32:27','GET','666',0),(96,1,'2016-05-15 14:32:29','GET','666',0),(97,1,'2016-05-15 14:32:31','GET','666',0),(98,1,'2016-05-15 14:32:33','GET','666',0),(99,1,'2016-05-15 14:32:35','GET','666',0),(100,1,'2016-05-15 14:32:37','GET','666',0),(101,1,'2016-05-15 14:32:39','GET','666',0),(102,1,'2016-05-15 14:32:41','GET','666',0),(103,1,'2016-05-15 14:32:43','GET','666',0),(104,1,'2016-05-15 14:32:45','GET','666',0),(105,1,'2016-05-15 14:32:47','GET','666',0),(106,1,'2016-05-15 14:32:49','GET','666',0);
...
CREATE TABLE `task_task` (
  ...
  `TASKSTATUS` int(10) NOT NULL COMMENT '任务状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `task_task` */

insert  into `task_task`(`ID`,`DEVICEID`,`STARTTIME`,`STOPTIME`,`TASKSTATUS`) values (1,1,'2016-05-06 20:54:12','2016-05-06 20:54:48',0),(17,1,'2016-05-15 14:31:40','2016-05-15 14:32:50',0);
